<?php
/**
 * Boston WordPress functions and definitions
 *
...
if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
	define( 'BOSTONWP_VERSION', time() );
} else {
	define( 'BOSTONWP_VERSION', '1.0.0' );
}
...
function bostonwp_setup() {
	 ...
	 * If you're building a theme based on Boston WordPress, use a find and replace
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'bostonwp' ),
	) );
...
function bostonwp_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bostonwp' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'bostonwp' ),
